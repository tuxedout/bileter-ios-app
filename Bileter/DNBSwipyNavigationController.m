...
@synthesize container = _container; //container for main view, not for left side table view;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.leftController.view.frame = CGRectMake(self.leftController.view.frame.origin.x, self.view.frame.origin.y + 20, self.leftController.view.frame.size.width, self.leftController.view.frame.size.height-20);
